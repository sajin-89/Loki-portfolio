...
<body>
    ...
    <header>
        ...
        <img src="/storage/emulated/0/Android/media/com.whatsapp/WhatsApp/Media/WhatsApp Images/IMG-20250403-WA0129.jpg"Logeshwari B class="profile-picture">
        <div class/storage/emulated/0/Download/95ce8566ed3b4d0aa672055082771a81-fotor-ai-art-effects-20250329202857.jpg"header-content">
            <h1>Logeshwari B</h1>
    ...
    <section id="education">
        <div class="section-content">
            <h2>Education</h2>
            <p><b> Loganatha narayanaswamy government college</b> - B.Sc. Computer Science (2023-2026)</p>
        </div>
    </section>
    ...
    <section id="contact">
        <div class="section-content">
            <h2>Contact Me</h2>
            <p>Email: <a href="Logeshwari B"> cs2301111058226@lngovernmentcollege.com</a></p>
        </div>
    </section>
    <footer>
